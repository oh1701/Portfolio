...
[주 사용 기술 및 라이브러리]
  ...
  * FlexBoxLayout (내용 입력 도중 태그 기능 활성화 시, 태그가 width를 넘길 시 자동적으로 다음 줄로 넘어가게 만들어줌)
  * RecyclerView (여러 목록들 보여주기 기능)
  * ViewModel (회원가입 및 사용자 정보 저장)
  * Coroutine (비동기 처리 및 메인 쓰레드 사용 불가능 이벤트 처리 시 사용)
...
[주 사용 기술 및 라이브러리]
  * GoogleMap (사용자의 활동 범위 파악)
  * Retrofit2 (API 활용)
  * FireBase (회원가입 및 사용자 정보 저장)
